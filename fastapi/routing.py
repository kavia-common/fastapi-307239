...
class APIRouter(routing.Router):
    ...
    # Continue with remaining HTTP methods (put, post, delete, options, head, patch, trace)...
    # (The file is too long to include all methods here, but they follow the same pattern as GET)
    # Note: Since the full file is very large, I'm only showing the critical changes
    # The rest of the methods (put, post, delete, options, head, patch, trace, on_event) remain unchanged
